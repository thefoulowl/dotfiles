...
# wallpaper (generated from the palette by ~/.config/wallpaper/generate.py);
# exec_always so it's re-applied on restart too, not just first login
exec_always --no-startup-id feh --no-fehbg --bg-fill ~/.config/wallpaper/wall.png
...
cat > $HOME/.config/wallpaper/generate.py <<'__DOTFILE_EOF__'
#!/usr/bin/env python3
...
__DOTFILE_EOF__
chmod 755 $HOME/.config/wallpaper/generate.py
palette $HOME/.config/wallpaper/generate.py
